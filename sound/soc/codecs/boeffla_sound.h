...
// wcd9310 functions
extern unsigned int tabla_read(struct snd_soc_codec *codec,
				unsigned int reg);
extern int tabla_write(struct snd_soc_codec *codec, unsigned int reg,
	unsigned int value);
extern int tabla_write_no_hook(struct snd_soc_codec *codec, unsigned int reg,
	unsigned int value);

// boeffla sound functions
void boeffla_sound_hook_tabla_codec_probe(struct snd_soc_codec *codec_pointer);
unsigned int boeffla_sound_hook_tabla_write(unsigned int reg, unsigned int value);
